...
import { getPenghuniById, PenghuniData } from "@/lib/api";
    ...
    return (
      <>
        <div className="max-w-7xl mx-auto px-4 py-6 md:px-6 md:py-8 text-center text-gray-500">
          ...
          <Link
            href="/pengelola/penghuni/daftar"
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 py-6 md:px-6 md:py-8">
        ...
        {/* Pengajuan Checkout Alert (read-only info) */}
        {isPengajuanCheckout && (
          <div className="bg-yellow-50 rounded-xl p-4 md:p-5 mb-4 border border-yellow-200">
            ...
            <p className="text-sm text-yellow-700">
              Penghuni ini mengajukan checkout dan sedang menunggu persetujuan pemilik.
            </p>
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 md:p-5 mb-4">
          ...
          {/* Action Buttons — Pengelola: hanya chat WA */}
